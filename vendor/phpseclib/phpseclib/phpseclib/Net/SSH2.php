...
class SSH2
{
    ...
    /**
     * Make sure that the logs never gets larger than this
     *
     * @access public
     * @see \phpseclib3\Net\SSH2::getLog()
     */
    ...
    /**
     * Real-time logs file wrap boolean
     *
     * @see self::_append_log()
     * @access private
     */
    ...
    private function append_log($message_number, $message)
    {
        ...
        switch (NET_SSH2_LOGGING) {
            ...
            // needs to be defined and that the resultant logs file will be capped out at self::LOG_MAX_SIZE.
            // the earliest part of the logs file is denoted by the first <<< START >>> and is not going to necessarily
    ...
    /**
     * Returns a logs of the packets that have been sent and received.
     *
    ...
    /*
     * Update packet types in logs history
     *
     * @param string $old
     * @param string $new
     * @access private
