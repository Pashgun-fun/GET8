...
{
  /**
   * Creates a view over logs entries in a logs bucket. A bucket may contain a
  ...
  /**
   * Deletes a view on a logs bucket. If an UNAVAILABLE error is returned, this
  ...
  /**
   * Gets a view on a logs bucket.. (views.get)
   *
  ...
  /**
   * Lists views on a logs bucket. (views.listOrganizationsLocationsBucketsViews)
   *
  ...
  /**
   * Updates a view on a logs bucket. This method replaces the following fields in
