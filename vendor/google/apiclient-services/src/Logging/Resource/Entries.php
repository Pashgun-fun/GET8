...
{
  /**
   * Copies a set of logs entries from a logs bucket to a Cloud Storage bucket.
   * (entries.copy)
   *
  ...
  /**
   * Lists logs entries. Use this method to retrieve logs entries that originated
   * from a project/folder/organization/billing account. For ways to export logs
  ...
  /**
   * Streaming read of logs entries as they are ingested. Until the stream is
  ...
  /**
   * Writes logs entries to Logging. This API method is the only way to send logs
   ...
   * A single request may contain logs entries for a maximum of 1000 different
