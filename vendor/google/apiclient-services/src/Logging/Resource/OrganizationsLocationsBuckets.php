...
{
  /**
   * Creates a logs bucket that can be used to store logs entries. After a bucket
   * has been created, the bucket's location cannot be changed. (buckets.create)
   *
   * @param string $parent Required. The resource in which to create the logs
  ...
  /**
   * Deletes a logs bucket.Changes the bucket's lifecycle_state to the
   * DELETE_REQUESTED state. After 7 days, the bucket will be purged and all logs
  ...
  /**
   * Gets a logs bucket. (buckets.get)
   *
  ...
  /**
   * Lists logs buckets. (buckets.listOrganizationsLocationsBuckets)
   *
  ...
  /**
   * Updates a logs bucket. This method replaces the following fields in the
  ...
  /**
   * Undeletes a logs bucket. A bucket that has been deleted can be undeleted
