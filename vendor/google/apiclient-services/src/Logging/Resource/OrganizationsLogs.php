...
{
  /**
   * Deletes all the logs entries in a logs for the _Default Log Bucket. The logs
   ...
   * (logs.delete)
   *
   * @param string $logName Required. The resource name of the logs to delete:
   ...
   * information about logs names, see LogEntry.
