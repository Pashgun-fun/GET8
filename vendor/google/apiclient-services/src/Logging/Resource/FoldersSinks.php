...
{
  /**
   * Creates a sink that exports specified logs entries to a destination. The
   * export of newly-ingested logs entries begins immediately, unless the sink's
   * writer_identity is not permitted to write to the destination. A sink can
   * export logs entries only from the resource owning the sink. (sinks.create)
   *
